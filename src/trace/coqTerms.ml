...
(* Int31 *)
let int31_modules = [["Coq";"Numbers";"Cyclic";"Int31";"Int31Native"]]

let cint = gen_constant int31_modules "int"
let ceq31 = gen_constant int31_modules "eqb"
