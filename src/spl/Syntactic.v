...
Section CheckAtom.
  ...
  Section AUX.
    ...
    Proof.
      ...
      (* Application *)
      intros [op2|op2 i2|op2 i2 j2|op2 li2|f2 args2]; simpl; try discriminate; unfold is_true; rewrite andb_true_iff, Int31Properties.eqb_spec; intros [H2 H1]; subst f2; rewrite (list_beq_correct _ _ H1); auto.
    Qed.
  ...
  Proof.
   ...
   rewrite Int31Properties.eqb_spec in H; rewrite H; reflexivity.
